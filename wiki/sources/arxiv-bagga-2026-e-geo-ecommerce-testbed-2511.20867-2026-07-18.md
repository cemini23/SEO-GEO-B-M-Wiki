...
**Phase-0:** Code repo **CONDITIONAL-GO** (cloned locally, ~0.5 MB; no SPDX LICENSE). HF full dataset **Watch** (not pulled). Hands-on: `briefs/2026-07-18_k142-e-geo-universal-rewrite-audit-hands-on.md`.
