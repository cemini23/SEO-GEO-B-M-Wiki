---
title: Metals / tungsten + Pt/Pd — Outlier Weekly queue notes
type: concept
tags: [social, substack, outlier-weekly, tungsten, platinum, palladium, metals]
keywords: [tungsten, APT, ELMT, ALM, platinum, palladium, interceptors, dip buyer]
related:
...
Markets practitioner. Same register as CXW/GEO, SPCX, GTA 6 cashout. Sell the **metal object**, not a ticker. CFTC 4.41.
...
| # | Title |
|---|-------|
| 1 | The war is a metals furnace. Tungsten is the one that does not grow back fast. |
| 2 | Four products, one word: why tungsten is the war metal and why we buy the other metals on a dip. |
| 3 | Interceptors are consumables. The metal under them is tungsten. |
| Dek | China still sits on the chemistry. Ukraine and Iran are burning the same stack. |

Slug ideas: `tungsten-war-metal-china-apt` or `tungsten-platinum-palladium-dip-buy`.

### One-sentence thesis

Two wars are burning the same Western industrial stack. The metal under that tape is tungsten. Platinum and palladium are why this desk buys metal weakness. Gold's 2025 record year is the example, not the trade.

### Copy guardrails

- Four tungsten forms stay separate (concentrate / APT / powder / carbide). NHK zero is **APT to Japan**, not every form.
- ALM = miner mention. ELMT = The Elmet Group mill (molybdenum interceptor award). ELT = Elementos Tasmania. Do not flatten.
- Carry AP "beyond critical" **and** O'Donnell / Parnell counters. 65% Patriots = CSIS via AP 27 Aug, not our census.
- "NATO may be tested" is a scenario, not a dated invasion.
- WPIC 995 / 848, not stale 476. JM has Pd walking toward balance (falsifier).
- WGC 2025: demand >5,000 t, 53 highs, CB 863 t (not 328 t).
- No live gold, APT, or equity prints. Dated Q2 APT ratio (about 7x year-earlier) is allowed.
- Tungsten has no retail futures/ETF rail. "Own the metal" is a posture. Do not funnel into ALM/ELMT.
- APT has already printed a large move. A later dip is a dip in a parabola, not a 2022-gold entry.
