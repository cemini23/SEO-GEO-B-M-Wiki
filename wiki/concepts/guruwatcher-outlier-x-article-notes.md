---
title: GuruWatcher — Outlier + X Article queue notes
type: concept
tags: [social, substack, outlier-weekly, x-twitter, guruwatcher, agents, alert-only]
...
Agent OSS / local systems **plus** markets practitioner. Sell wiring and alert discipline. Do **not** sell picks, edge, or order automation. Repo is **private** — no star/fork CTA until public.
