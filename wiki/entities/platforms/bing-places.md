...
Stub entity page for Bing Places for Business — Microsoft's equivalent to GBP, powering Bing Search local pack, Bing Maps, Cortana, Microsoft Copilot, and (via partnerships) some Alexa local lookups.
...
(none yet — populate via ingest of `bingplaces.com` docs)
